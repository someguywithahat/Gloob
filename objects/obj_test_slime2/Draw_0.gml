	...
	texture_set_stage(u_palette_swap_old, sprite_get_texture(spr_palette_all, 0));
	texture_set_stage(u_palette_swap_new, sprite_get_texture(spr_palette_all, 3));

	// Send color count
	shader_set_uniform_f(u_color_count, 6.0);
	shader_set_uniform_f(u_color_merge, 0.5);
