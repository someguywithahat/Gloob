...
if gloop.powerUp1>0
	draw_sprite(spr_PowerUp, gloop.powerUp1-1, xx+52, yy+48)
if gloop.powerUp2>0
	draw_sprite(spr_PowerUp, gloop.powerUp2-1, xx+52+32, yy+48)
if gloop.powerUp3>0
	draw_sprite(spr_PowerUp, gloop.powerUp3-1, xx+52+64, yy+48)	
